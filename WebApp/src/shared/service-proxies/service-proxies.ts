...
@Injectable()
export class HangfireManageServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return OK
     */
    createJob(frequency: string | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/HangfireManage/CreateJob?";
        if (frequency === null)
            throw new Error("The parameter 'frequency' cannot be null.");
